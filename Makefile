...
HOSTCC       = ccache gcc
HOSTCXX      = g++
HOSTCFLAGS   := -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer -pipe -std=gnu89
HOSTCXXFLAGS = -O3
...
KBUILD_CFLAGS   := -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs \
		   ...
		   -Wno-format-security \
		   -std=gnu89 -pipe $(call cc-option,-fno-PIE)
...
LLVM_AR		:= /home/alexandre/Música/Eureka-Kernel-Exynos7885-Q-R-S/toolchain/bin/llvm-ar
LLVM_NM		:= /home/alexandre/Música/Eureka-Kernel-Exynos7885-Q-R-S/toolchain/bin/llvm-nm
...
ifdef CONFIG_LD_DEAD_CODE_DATA_ELIMINATION
LDFLAGS_vmlinux	+= $(call ld-option, --gc-sections,) -z nostart-stop-gc
endif
